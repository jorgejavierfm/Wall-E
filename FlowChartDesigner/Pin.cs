...
namespace FlowChartDesigner
{
    ...
    public class Pin
    {
        ...
        /// </summary>
        public ChartElement ChartElement { get { return _ChartElement; } private set { _ChartElement = value; } }
        ...
        /// <summary>
        /// Determina la posicion actual del pin. Esta posicion se define para cada pin a traves de los metodos GetPositionForInputPin y GetPositionForOutputPin del tipo abstracto ChartElement.
        /// </summary>
